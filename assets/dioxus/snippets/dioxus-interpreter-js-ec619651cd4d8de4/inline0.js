            ...
            export class RawInterpreter extends BaseInterpreter {
                constructor(r) {
                    ...
                    };this.s = "";this.lsp = null;this.sp = null;this.sl = null;this.c = new TextDecoder();this.u32buf=null;this.u32bufp=null;this.evt = [];
                    ...
                    };this.u16buf=null;this.u16bufp=null;this.u8buf=null;this.u8bufp=null;this.namespace = [];
            ...
            this.u8bufp=0;
                    for(;;){
                        ...
                        while(this.z++<4){
                            switch(this.op&255){
                                case 0:{this.appendChildren(this.root, this.stack.length-1);}break;case 1:{this.pushRoot(this.nodes[this.u32buf[this.u32bufp++]]);}break;case 2:{this.appendChildren(this.u32buf[this.u32bufp++], this.u16buf[this.u16bufp++]);}break;case 3:{this.stack.pop();}break;case 4:{const root = this.nodes[this.u32buf[this.u32bufp++]]; let els = this.stack.splice(this.stack.length-this.u16buf[this.u16bufp++]); if (root.listening) { this.removeAllNonBubblingListeners(root); } root.replaceWith(...els);}break;case 5:{let node = this.nodes[this.u32buf[this.u32bufp++]];node.after(...this.stack.splice(this.stack.length-this.u16buf[this.u16bufp++]));}break;case 6:{let node = this.nodes[this.u32buf[this.u32bufp++]];node.before(...this.stack.splice(this.stack.length-this.u16buf[this.u16bufp++]));}break;case 7:{let node = this.nodes[this.u32buf[this.u32bufp++]]; if (node !== undefined) { if (node.listening) { this.removeAllNonBubblingListeners(node); } node.remove(); }}break;case 8:{this.stack.push(document.createTextNode(this.s.substring(this.sp,this.sp+=this.u32buf[this.u32bufp++])));}break;case 9:{let node = document.createTextNode(this.s.substring(this.sp,this.sp+=this.u32buf[this.u32bufp++])); this.nodes[this.u32buf[this.u32bufp++]] = node; this.stack.push(node);}break;case 10:{let node = document.createComment('placeholder'); this.stack.push(node); this.nodes[this.u32buf[this.u32bufp++]] = node;}break;case 11:id=this.u32buf[this.u32bufp++];
        ...
        }break;case 16:{this.nodes[this.u32buf[this.u32bufp++]] = this.loadChild(this.u32buf[this.u32bufp++], this.u8buf[this.u8bufp++]);}break;case 17:{let els = this.stack.splice(this.stack.length - this.u16buf[this.u16bufp++]); let node = this.loadChild(this.u32buf[this.u32bufp++], this.u8buf[this.u8bufp++]); node.replaceWith(...els);}break;case 18:{let node = this.templates[this.u16buf[this.u16bufp++]][this.u16buf[this.u16bufp++]].cloneNode(true); this.nodes[this.u32buf[this.u32bufp++]] = node; this.stack.push(node);}break;case 19:many=this.u16buf[this.u16bufp++];{
            let root = this.stack[this.stack.length-many-1];
            let els = this.stack.splice(this.stack.length-many);
            for (let k = 0; k < many; k++) {
                root.appendChild(els[k]);
            }
        }break;case 20:{this.setAttributeInner(this.stack[this.stack.length-1], this.get_attr(), this.s.substring(this.sp,this.sp+=this.u32buf[this.u32bufp++]), this.get_ns_cache());}break;case 21:{let node = document.createComment('placeholder'); this.stack.push(node);}break;case 22:{this.stack.push(document.createElement(this.get_el()))}break;case 23:{this.stack.push(document.createElementNS(this.get_namespace(), this.get_el()))}break;case 24:{this.templates[this.u16buf[this.u16bufp++]] = this.stack.splice(this.stack.length-this.u16buf[this.u16bufp++]);}break;case 25:id=this.u32buf[this.u32bufp++];bubbles=this.u8buf[this.u8bufp++];
    bubbles = bubbles == 1;
    ...
    }break;case 26:{this.nodes[this.u32buf[this.u32bufp++]] = this.loadChild((()=>{this.e=this.u8bufp+this.u32buf[this.u32bufp++];const final_array = this.u8buf.slice(this.u8bufp,this.e);this.u8bufp=this.e;return final_array;})());}break;case 27:{let els = this.stack.splice(this.stack.length - this.u16buf[this.u16bufp++]); let node = this.loadChild((()=>{this.e=this.u8bufp+this.u32buf[this.u32bufp++];const final_array = this.u8buf.slice(this.u8bufp,this.e);this.u8bufp=this.e;return final_array;})()); node.replaceWith(...els);}break;case 28:return true;
                            }
                            this.op>>>=8;
                        }
                    }
